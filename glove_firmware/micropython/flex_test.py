"""AirPen glove - index finger flex sensor test on GPIO 34 (MicroPython, Thonny).

Prints the GPIO 34 reading five times a second with a simple bar, and says
what the number means. Bend and straighten the index finger and watch it move.
"""
...
def describe(value):
    if value < DISCONNECTED_BELOW:
        return "NOT CONNECTED - check the sensor legs and the GPIO 34 wire"
...
print("GPIO 34 flex test - press Ctrl+C to stop\n")
